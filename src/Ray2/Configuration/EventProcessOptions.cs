...
namespace Ray2.Configuration
{
    ...
    {
        public EventProcessOptions(string processorName, string processorFullName, string eventSourceName,int onceProcessCount, TimeSpan onceProcessTimeout, StatusOptions statusOptions, IList<EventSubscribeOptions> subscribeOptions)
        {
