...
namespace Ray2
{
    ...
    /// </summary>
    public abstract class EventProcessorGrain<TState, TStateKey> : Grain, IEventProcessor
           where TState : IState<TStateKey>, new()
    {
        ...
        private EventProcessConfig config;
        private EventSourcesConfig eventSourcesConfig;
        ...
        public EventProcessorGrain(ILogger logger)
        {
            this.Logger = logger;
        }
    ...
    public abstract class EventProcessorGrain<TStateKey> : EventProcessorGrain<EventProcessState<TStateKey>, TStateKey>
    {
        public EventProcessorGrain(ILogger logger) : base(logger)
        {
